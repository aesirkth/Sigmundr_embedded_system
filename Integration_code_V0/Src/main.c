...
int main(void)
{
  /* USER CODE BEGIN 1 */
	...
	float PITOT_conv = 0.0, PITOT_convSpeed = 0.0;				//pressure Pa and Speed m/s

	param Bmp2, Bmp3;											//compensation parameters for BMP

	unsigned int err_msg = 0;
  /* USER CODE END 1 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  //PITOT_conv = convPITOT(PITOT_raw);
	  //PITOT_convSpeed = convSpeedPITOT(PITOT_conv);
